        ...
        if (!currentList.isEmpty()) {
            ...
            switch (sortType) {
                case "LastName": {
                    ...
                    currentList.sort(Comparator.comparing(Student::getLastName));
                    break;
                }
                case "FirstName": {
                    System.out.println("Sorting by First name:");
                    currentList.sort(Comparator.comparing(Student::getFirstName));
                    break;
                }
                case "Age": {
                    System.out.println("Sorting by Age:");
                    currentList.sort((Comparator.comparingInt(Student::getAge)));
                    break;
                }
                default: {
                    currentList.sort(Comparator.comparing(Student::getLastName));
